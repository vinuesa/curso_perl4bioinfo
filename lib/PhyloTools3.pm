...
# NOTE: 1, 0 stand for cleanup=1 and verbosity_level=0; see function description below

=head1 DESCRIPTION

This module currently exports the subroutines run_muscle and run_clustalo to perform multiple sequence alignments.
